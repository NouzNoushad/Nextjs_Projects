    ...
    return (
        <div className="px-8 py-9 w-full bg-white rounded-md ring-1 ring-gray-100 space-y-5 shadow-[0px_3px_4px_0px_rgba(0,0,0,0.03)]">
            ...
            <div className="flex items-center justify-between mb-10">
                ...
                <div>
                    <button className='bg-blue-500 text-white px-5 py-3 rounded-md text-sm font-medium focus:outline-none foucs:ring-0 transition-colors hover:bg-blue-600'>Add Category</button>
                </div>
            </div>
            {/* Category Table */}

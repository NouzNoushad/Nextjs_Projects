        ...
        <main className='h-[calc(100vh-10vh)]'>
            <div className="max-w-[600px] mx-auto px-5 xl:px-0 h-full">
                <div className="flex flex-col items-center justify-center h-full text-white space-y-8">
                    ...
                    <p className='text-center  text-[1.2rem] font-bold drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]'>I’d love to hear from you! Whether you have a question, an exciting project to discuss, or just want to connect, feel free to reach out.</p>
                    <div className="flex items-center gap-x-5">
                        <Link href={'https://github.com/NouzNoushad'} className="">

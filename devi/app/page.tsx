            ...
            <header className="h-[12vh] py-8 fixed top-0 left-0 w-full bg-black z-50 transition-all duration-200">
                <div className="max-w-[1150px] mx-auto px-6 xl:px-0 text-white flex flex-row items-center justify-between h-full">
                    ...
                    <nav className="flex flex-row items-center gap-[35px]">
                        <ul className="flex flex-row items-center justify-center gap-[35px] uppercase font-semibold text-sm">
                        ...
                        <button className="border-2 border-white px-2 py-2 rounded-sm uppercase text-xs w-[9rem] font-medium cursor-pointer transition-colors duration-150 hover:bg-[#FF4A17] hover:text-white hover:border-[#FF4A17]">
                            Get Started
                        </button>
                    </nav>
                </div>

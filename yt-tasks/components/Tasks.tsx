                        ...
                        <div className="flex flex-row items-center justify-between">
                            ...
                            <div className="flex flex-row items-center gap-1">
                                ...
                                <div className="h-[30px] w-[30px] rounded-full bg-slate-50">
                                    {task.assignee.image.file_path != "" ? <Image src={`http://localhost:8020/uploads/${task.assignee.image.filename}`} height={10} width={30} alt='profile' className='rounded-full h-[30px] w-[30px]' /> : null}
                                </div>
                            </div>
                        </div>
                    </div>

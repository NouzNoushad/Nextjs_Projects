                ...
                <div className="rounded-lg primary-color px-4 py-4 shadow-lg">
                    ...
                    <form action="" className='mt-5 space-y-3'>
                        <div className="flex flex-col gap-1">
                            ...
                            <input type="text" placeholder='Task name' className='w-full rounded-md px-2 py-2 bg-color placeholder:text-[0.9rem]' />
                        </div>
                        <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-row items-center gap-3">
                                <input type="text" placeholder='Assignee name' className='w-[50%] rounded-lg px-2 py-2 bg-color text-[0.9rem] placeholder:text-[0.9rem]' />
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <textarea rows={4} placeholder='Task description' className='w-full rounded-md px-2 py-2 bg-color placeholder:text-[0.9rem]'></textarea>
                        </div>

export const HomeIcon = ({className, fill = "currentColor"}: {className: string; fill?: string}) => (
...
export const ImportantIcon = ({className}: {className: string}) => (
...
export const DoItNowIcon = ({className}: {className: string}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
